"""Split a transparent 2x2 crawl sheet into normalized directional frames."""
...
def main() -> int:
    ...
    with Image.open(args.sheet).convert("RGBA") as sheet:
        ...
        boxes = (
            ...
            (cell_width, 0, sheet.width, cell_height),
            (0, cell_height, cell_width, sheet.height),
            (cell_width, cell_height, sheet.width, sheet.height),
        )
        ...
        for index, box in enumerate(boxes, start=1):
            ...
            left_path = args.output_dir / f"haqi_cat_crawl_left_{index:02d}.png"
            right_path = args.output_dir / f"haqi_cat_crawl_right_{index:02d}.png"
