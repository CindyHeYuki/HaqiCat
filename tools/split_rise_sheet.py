"""Split a transparent two-frame rising sheet and mirror both poses."""
...
def main() -> int:
    ...
    with Image.open(args.sheet).convert("RGBA") as sheet:
        ...
        for index, box in enumerate(boxes, start=1):
            ...
            left_path = args.output_dir / f"haqi_cat_rise_left_{index:02d}.png"
            right_path = args.output_dir / f"haqi_cat_rise_right_{index:02d}.png"
